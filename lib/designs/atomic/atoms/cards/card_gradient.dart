...
/// {@template card_gradient}
/// A [CardGradient] atom for the Stoyco Subscription Atomic Design System.
/// Renders a card with customizable gradient border, background color, and child widget.
///
/// ### Atomic Level
...
///
/// ### Returns
/// Renders a card with gradient border, customizable background, and child container.
///
/// ### Example
/// ```dart
/// CardGradient(
...
/// {@macro card_gradient}
  /// Creates a [CardGradient] atom for the Stoyco Subscription Design System.
  ///
  /// - [child]: The widget below the card, typically the main content.
  /// - [width]: The width of the card. If null, the card will size to its child.
  /// - [height]: The height of the card. If null, the card will size to its child.
