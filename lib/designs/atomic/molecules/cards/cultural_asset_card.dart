...
class CulturalAssetCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: culturalAssetCard.accessContent?.isActive ?? false
          ? () {
              if (onTap != null) {
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: ImageNetworkBlur(
                            ...
                            isBlur: !(culturalAssetCard.accessContent?.isActive ?? false),
                            fit: BoxFit.cover,
                          ),
                        ),
                        Align(
                          ...
                          child: TagLocked(
                            isLocked: !(culturalAssetCard.accessContent?.isActive ?? false),
                          ),
                        ),
                      ],
                    ),
