...
class SubscriptionCatalogNotifier extends ChangeNotifier {
  ...
  final List<SubscriptionCatalogItem> musicSubscriptions = <SubscriptionCatalogItem>[
  ...
  final List<SubscriptionCatalogItem> sportSubscriptions = <SubscriptionCatalogItem>[
    const SubscriptionCatalogItem(
      id: '681bb4ed712816d61286b1af',
  ...
  final List<SubscriptionCatalogItem> brandSubscriptions = <SubscriptionCatalogItem>[
    const SubscriptionCatalogItem(
      id: '681bb4ed712816d61286b1af',
  ...
  List<SubscriptionCatalogItem> filteredSubscriptions = <SubscriptionCatalogItem>[];
  String searchText = '';
  ...
  void _loadMore() {
    ...
    switch (selectedIndex) {
      ...
      default:
        source = <SubscriptionCatalogItem>[];
    }
